...
class AssignedJobDetailsApiServices{

  static const String url = baseURL+"api/scheduledetails";
  static Future AssignedJobDetailsApiCall(
   ...
   // print(userid);
    ...
    try {
      ...
      Map<String, String> params = {"id":userid.toString()};
      final response =
